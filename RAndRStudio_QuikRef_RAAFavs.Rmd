...
```
# base::  base R  
This is not an exhaustive list, just a small, curated presentation of my most-beloved `R` and `RStudio` operands, shortcuts, functions, and more.   
...
**note** only one (1) occurrence of `mydf` needed for all this work! Insert googly-eyed emoji here.  
